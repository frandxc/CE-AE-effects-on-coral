...
setwd('D:/my paper/2018-OLIVINE/滨共表达和论文/2021R/make orgdb')
anno_all <- read.csv('D:/my paper/2018-OLIVINE/滨共表达和论文/2021R/raw data/All_Unigene.advance.annotation.csv', header = T, row.names=1)
