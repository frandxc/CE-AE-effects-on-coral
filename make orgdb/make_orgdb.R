...
setwd('D:/my paper/2018-OLIVINE/滨共表达和论文/2021R - 副本/make orgdb')
...
filtered_coral <- subset(anno_all, grepl("\\[Acropora digitifera\\]|\\[Exaiptasia pallida\\]|\\[Acropora millepora\\] |\\[Nematostella vectensis\\]", Nr.annotation))
